...
final class DatabaseProvider extends $FunctionalProvider<
    N3VocabularyDatabase,
    N3VocabularyDatabase,
    N3VocabularyDatabase> with $Provider<N3VocabularyDatabase> {
  DatabaseProvider._()
      : super(
          from: null,
          argument: null,
  ...
  @$internal
  @override
  $ProviderElement<N3VocabularyDatabase> $createElement(
          $ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  N3VocabularyDatabase create(Ref ref) {
    return database(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(N3VocabularyDatabase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<N3VocabularyDatabase>(value),
    );
  }
}

String _$databaseHash() => r'383f557b313bf307566297ea2df6f80c0867de0d';

@ProviderFor(repository)
final repositoryProvider = RepositoryProvider._();

final class RepositoryProvider extends $FunctionalProvider<
    N3VocabularyRepository,
    N3VocabularyRepository,
    N3VocabularyRepository> with $Provider<N3VocabularyRepository> {
  ...
  @$internal
  @override
  $ProviderElement<N3VocabularyRepository> $createElement(
          $ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  N3VocabularyRepository create(Ref ref) {
    return repository(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(N3VocabularyRepository value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<N3VocabularyRepository>(value),
    );
  }
}

String _$repositoryHash() => r'555f60f1ecae41f933617bfa328f211025671614';

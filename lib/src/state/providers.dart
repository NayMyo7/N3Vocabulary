...
import '../data/db/n3vocabulary_database.dart';
import '../data/repositories/n3vocabulary_repository.dart';
...
@Riverpod(keepAlive: true)
N3VocabularyDatabase database(Ref ref) {
  final db = N3VocabularyDatabase();
  ref.onDispose(db.close);
  return db;
}

@riverpod
N3VocabularyRepository repository(Ref ref) {
  final db = ref.watch(databaseProvider);
  return N3VocabularyRepository(db);
}
